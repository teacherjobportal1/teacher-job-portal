...
//     cell1.textContent = `${schools[i].name} (${schools[i].district})`;
//     row.appendChild(cell1);

//     if (schools[i + 1]) {
//         const cell2 = document.createElement("td");
//         cell2.textContent = `${schools[i + 1].name} (${schools[i + 1].district})`;
...
// // searching for school name or district in search bar 
...
//         const cell1 = document.createElement("td");
//         cell1.textContent = `${filtered[i].name} (${filtered[i].district})`;
//         row.appendChild(cell1);

//         if (filtered[i + 1]) {
//             const cell2 = document.createElement("td");
//             cell2.textContent = `${filtered[i + 1].name} (${filtered[i + 1].district})`;
//             row.appendChild(cell2);
//         }
